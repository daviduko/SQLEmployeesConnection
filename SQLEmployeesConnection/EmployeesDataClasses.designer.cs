...
namespace SQLEmployeesConnection
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="DavidSanzEmployees")]
    ...
    partial void Deletelocations(locations instance);
		...
		public EmployeesDataClassesDataContext() : 
				base(global::SQLEmployeesConnection.Properties.Settings.Default.DavidSanzEmployeesConnectionString, mappingSource)
		{
			OnCreated();
		}
